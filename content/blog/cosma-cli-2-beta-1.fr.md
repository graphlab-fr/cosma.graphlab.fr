...
Ceci est la première bêta de Cosma CLI v2. Elle comprend trois changements majeurs :
...
2. Les projets ! Cosma est maintenant capable de gérer plusieurs projets, chacun correspondant à une source de données. Vous pouvez gérer chaque projet localement ou stocker les configurations de tous vos projets dans un répertoire de données utilisateur centralisé.
